...
class UtilUnitTestTest extends PHPUnit_Framework_TestCase
{
    public function testPrivateStatic() {
        $this->assertEquals(20, UtilUnitTest::call_private_or_protected_static_method('ClassToTest', '__privateStatic', 10));
    }

    public function testProtectedStatic() {
        $this->assertEquals(30, UtilUnitTest::call_private_or_protected_static_method('ClassToTest', '_protectedStatic', 10));
    }

    public function testPrivateNonStatic() {
        $o = new ClassToTest();
        $o->factor = 4;
        $this->assertEquals(40, UtilUnitTest::call_private_or_protected_method('ClassToTest', '__privateNonStatic', $o, 10));
    }

    public function testProtectedNonStatic() {
        $o = new ClassToTest();
        $o->factor = 5;
        $this->assertEquals(50, UtilUnitTest::call_private_or_protected_method('ClassToTest', '_protectedNonStatic', $o, 10));
    }
}